...
import { ArrowLeft, ShoppingCart, MessageCircle, Package, Tag, Loader2, AlertCircle, CheckCircle, Star } from 'lucide-react';
...
const ProductPage = () => {
    ...
    const handleWhatsApp = () => {
        ...
        window.open(`https://wa.me/918888888888?text=${encodeURIComponent(msg)}`, '_blank');
    };
    ...
    if (notFound || !product) {
        return (
            <div className="min-h-screen bg-[#f8f9fa] flex flex-col items-center justify-center px-6 text-center">
                ...
                <p className="text-gray-400 text-sm mb-6">The product you're looking for doesn't exist or may be discontinued.</p>
                <Link to="/" className="px-5 py-2.5 bg-emerald-500 text-white rounded-xl font-medium text-sm hover:bg-emerald-600 transition-colors">
                    Browse Products
                </Link>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fa] flex flex-col">
            ...
            {/* Content */}
            <div className="flex-1 pt-[64px] pb-36">
                {/* Product Image */}
                ...
                {/* Browse more */}
                <div className="mx-4 mt-3 p-4 bg-white rounded-2xl">
                    <p className="text-xs text-gray-500 mb-2">Explore more products</p>
