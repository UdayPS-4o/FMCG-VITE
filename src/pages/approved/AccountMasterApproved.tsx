    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-6 overflow-hidden">
        <div className="bg-white max-w-[1140px] dark:bg-gray-800 rounded-lg shadow-sm p-6 w-full overflow-hidden">
          <h2 className="text-xl font-semibold mb-6 text-gray-800 dark:text-white">Account Master Approved Data</h2>
          <DatabaseTable endpoint="account-master" tableId="account-master-approved" />
        </div>
      </div>
    </div>
  );
